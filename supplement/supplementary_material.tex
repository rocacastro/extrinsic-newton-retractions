...
Extrinsic Newton Method with Retractions\\
...
\maketitle
\begin{center}
\small Institute of Mathematics, Universidad de Valpara\'iso, Valpara\'iso, Chile
\end{center}

\section*{Scope of the Supplementary Material}
This document complements the main manuscript. It presents an example on
...
the supplement is adjusted manually.
\endgroup
\end{document}
